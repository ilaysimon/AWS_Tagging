...
def check_scaling_policies(list_ASG_names,ASG_client):
    ...
    return ASG_manual
    # return(f"ASG_manual: {ASG_manual}")
    ...
    for region in all_region :
        ...
        if get_auto_scaling_groups_names(ASG_client):
            ...
            if check_scaling_policies(list_all_ASG_names , ASG_client):
                ...
                logging.info("{0} : {1}".format(region ,list_manual_ASG_names)
...
def lambda_handler(event, context):
    ...
    #           list_manual_ASG_names.append(check_scaling_policies(list_all_ASG_names , ASG_client))
    # print(dict(zip(list_region, list_manual_ASG_names)))           
